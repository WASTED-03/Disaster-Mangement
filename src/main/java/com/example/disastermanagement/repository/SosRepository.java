...
public interface SosRepository extends JpaRepository<SosRequest, Long> {
    ...
    /**
     * Find all auto-generated SOS requests, ordered by timestamp descending.
     * 
     * @return List of all auto-generated SOS requests
     */
    List<SosRequest> findByAutoGeneratedTrueOrderByTimestampDesc();
